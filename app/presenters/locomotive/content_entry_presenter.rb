module Locomotive
  class ContentEntryPresenter < BasePresenter
    ...
    delegate  :_label, :_slug, :_position, :translated_in, :seo_title,
              ...
              :file_custom_fields, :has_many_custom_fields, 
              :many_to_many_custom_fields, :tag_set_custom_fields, :to => :source
    ...
    def included_methods
      default_list = %w(_label _slug _position content_type_slug select_custom_fields file_custom_fields has_many_custom_fields many_to_many_custom_fields translated_in tag_set_custom_fields safe_attributes)
